...
const { addToCookieList, overwriteCookieList } = require("../helpers/cookies");
...
const getProductsByCategory = async (req, res) => {
  ...
  addToCookieList(res, req, "search-history", rawQuery);
...
const getProductByName = async (req, res) => {
  ...
  try {
    ...
    overwriteCookieList(res, req, "ctr-product-category", product.category);
